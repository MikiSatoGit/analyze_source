...
def analyze_control_statement_backup(proc_codes):
...
###### find '(' of condition
							if proc_codes.proc_data_list[index1_r].left[index2_r].find('(')!=-1:
								...
								tmp_num -= proc_codes.proc_data_list[index1_r].left[index2_r].count('(')
								print tmp_num

#								if bracket_search==True:
#									bracket_level -= proc_codes.proc_data_list[index1_r].left[index2_r].count('(')
#									print '-=%d' % proc_codes.proc_data_list[index1_r].left[index2_r].count('(')
#									print '(%s)(%d)' % ( bracket_search, bracket_level)
...
#									print '(%s)(%d)' % ( bracket_search, bracket_level)
								...
								bracket_level += tmp_num
								print '1. (%s)(%d)' % ( bracket_search, bracket_level)
								if bracket_level==0:
									bracket_search = False
									print '2. (%s)(%d)' % ( bracket_search, bracket_level)
